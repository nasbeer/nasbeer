...
(e = function () {
  ...
  c &&
    ((f = (u.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(
      u.readyState
    )) ||
          ...
          var c = Array.from(u.scripts).filter(function (e) {
            ...
            e = function (e) {
              ...
              (r.innerText = "("
                ...
                .concat(i, "');")),
                (t.onload = function () {
                  t.contentWindow.addEventListener("error", T, !0),
      ...
      o = (function () {
        ...
        function n(e, t) {
          ...
          (i.innerText = "("
              ...
              function (n, o, r, i) {
                parent.FontAwesomeDetection.__pollUntil({
                  fn: function () {
                    ...
                    return !(
                      !t.match(/FontAwesome/) && !t.match(/Font Awesome 6/)
                    );
                  },
                })
                  .then(function () {
            ...
            .concat(c, "');")),
            (n.onload = function () {
              n.contentWindow.addEventListener("error", T, !0),
